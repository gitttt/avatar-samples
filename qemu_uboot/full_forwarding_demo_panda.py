...
import logging
from avatar.emulators.panda_emulator import init_panda_emulator
import threading
import subprocess
...
def main(args, env):
    ...
    ava = System(configuration, init_panda_emulator, init_gdbserver_target)
    ava.init()
...
def parse_args():
    ...
    parser.add_argument("--gdb-path", dest = "gdb_path", default = os.path.expanduser("~/gdb_avatar/gdb"), type = str, help = "Path to ARM gdb, used for to get gdb's data_directory")
    parser.add_argument("--gdb", dest = "gdb", default = os.path.expanduser("~/gdb_avatar/gdb/gdb/gdb"), type = str, help = "Path to ARM gdb executable")
    parser.add_argument("--panda", dest = "panda", default = os.path.expanduser("~/panda/qemu/arm-softmmu/qemu-system-arm"), type = str, help = "Path to panda executable")
